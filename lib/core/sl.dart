...
void setUpDependencies() {
  ...
  sl.registerLazySingleton<ProductDataSource>(
      () => ProductDataSourceImpl(db: sl())); sl.registerLazySingleton<SearchDataSource>(
      () => SearchDataSourceImpl(  firebaseFireStore: sl()));
  sl.registerLazySingleton<CartRepository>(
      () => CartRepositoryImpl(firebaseFirestore: sl())); sl.registerLazySingleton<SearchRepository>(
